...
module.exports.aboutMessage = new Discord.MessageEmbed()
	...
	.setFooter('DM bot to use the bot. Bot will not provide services in channels.');

module.exports.registerMessage=new Discord.MessageEmbed()
	.setColor('#0099ff')
	.setTitle('VacBot Help')
	.addFields({name: '\u200B', value: '\u200B' },
				{ name: 'To register', value: 'register <district code> <age>'},
				{name: '\u200B', value: '\u200B' })
...
module.exports.showMessages=new Discord.MessageEmbed()
	...
	.setTitle('VacBot Help')
	.addFields( {name: '\u200B', value: '\u200B' },
				{name: 'To See States', value: 'show states  '},
				{ name: 'To See Districts', value: 'show districts <district code>  '},
				{ name: 'To See Your data', value: 'show mydata '},
				{name: '\u200B', value: '\u200B' },)
	.setFooter("Type 'help' to see all commands");
module.exports.checkMessages=new Discord.MessageEmbed()
	...
	.setTitle('VacBot Help')
	.addFields({name: '\u200B', value: '\u200B' },
				{ name: 'Check by Pincode', value: 'check pincode <pincode>  <dd-mm-yyyy>'},
				{ name: 'Check by District', value: 'check district <district code> <dd-mm-yyyy>'},
				{name: '\u200B', value: '\u200B' },)
	.setFooter("Type 'help' to see all commands");
module.exports.updateMessage=new Discord.MessageEmbed()
	...
	.setTitle('VacBot Help')
	.addFields({name: '\u200B', value: '\u200B' },
				{ name: 'Update Age', value: 'update <age>'},
